from service.models import Room, Booking, Specialty
from rest_framework import serializers

class SpecialtySerializer(serializers.ModelSerializer):
    name = serializers.CharField(max_length=100, default="Specialty")
...
class RoomSerializer(serializers.ModelSerializer):
    ...
    specialties = serializers.PrimaryKeyRelatedField(queryset=Specialty.objects.all(), many=True, required=False, default=list)
